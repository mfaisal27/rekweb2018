...
<div class="container-fluid" style="margin-top: 100px">
	...
	<div class="card card-cascade narrower">
		...
		<div class="view gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
			<div class="white-text mx-3">Tabel Buku-buku Terkenal di Indonesia</div>
		</div>
		<div class="px-5">
					...
					<?php if (!empty($buku)) : ?>
						<?php foreach ($buku as $key): ?>
							<tr>
								...
								<td>
									<div class=" overlay hm-zoom">
										<img src="<?php echo base_url('assets/img/') ?><?php echo $key->cover ?>"
											 class="img-fluid img-thumbnail" alt="zoom"
								...
								<td style="top: -20px; position: relative"><a href="<?= site_url('buku/edit/' . $key->id_buku) ?>">
										<button type="button" class="btn-floating blue-gradient"><i class="fa fa-edit"></i></button>
									</a> | <a href="<?= site_url('buku/delete/' . $key->id_buku) ?>" onclick="return confirm('Apakah ingin menghapus data ini ?')">
