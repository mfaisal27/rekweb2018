		...
		<div class="container-fluid" style="margin-top: 64px">
			...
			<div class="card card-cascade narrower">
				...
				<div class="card-body  wow fadeIn" data-wow-delay="0.2s">
					<form action="<?php echo site_url('buku/insert') ?>" method="post" class="form-inline"
						  style="margin: auto;" enctype="multipart/form-data">
						<div class="md-form form-group">
							<label for="form7">Judul Buku</label>
							<input type="text" id="form7" name="judul" class="form-control">
						</div>

						<div class="md-form form-group">
							<label for="form9">Penulis</label>
							<input type="text" id="form9" name="penulis" class="form-control">
						</div>

						<div class="md-form form-group">
							<label for="form8">ISBN</label>
							<input type="number" id="form8" name="isbn" class="form-control">
						</div>

						<div class="md-form form-group">
							<label for="date-picker-example form11">Tahun Terbit</label>
							<input type="text" name="tahun" id="date-picker-example" class="form-control datepicker">
						</div>
