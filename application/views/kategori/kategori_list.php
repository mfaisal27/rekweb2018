...
<div class="container-fluid" style="margin-top: 100px">
	...
	<div class="card card-cascade narrower">
		...
		<div class="view gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
			<div class="white-text mx-3">Tabel kategori Buku</div>
		</div>
		<div class="px-5">
					...
					<?php $i = 1; ?>
						<?php foreach ($kategori as $key): ?>
							<tr>
								...
								<td style="top: -20px; position: relative"><a href="<?= site_url('kategori/edit/' . $key->id_kategori) ?>">
										<button type="button" class="btn-floating blue-gradient"><i class="fa fa-edit"></i></button>
									</a> | <a href="<?= site_url('kategori/delete/' . $key->id_kategori) ?>" onclick="return confirm('Apakah ingin menghapus data ini ?')">
