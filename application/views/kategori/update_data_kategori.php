	...
	<div class="container-fluid" style="margin-top: 64px">
		...
		<div class="card card-cascade narrower">
			<div class="view gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
				<div class="white-text mx-3">UPdate Data Kategori</div>
			</div>
			<!--Card content-->
			<div class="card-body  wow fadeIn" data-wow-delay="0.2s">
				<form action="<?php echo site_url('kategori/update') ?>" method="post" class="form-inline"
					  style="margin: auto;" enctype="multipart/form-data">
					<input type="hidden" name="id_kategori" value="<?= $kategori->id_kategori ?>">
					<div class="md-form form-group">
						<label for="form7">Nama Kategori</label>
						<input type="text" id="form7" name="kategori" value="<?= $kategori->nama_kategori ?>" class="form-control">
					</div>
